    ...
    <form className="flex items-center w-full mx-6 grow lg:mx-40 glass">
      ...
      <div className="relative w-full">
        ...
        <input
          type="text"
          id="voice-search"
          className="text-gray-900 text-sm rounded-lg focus:ring-primaryBlue focus:border-primaryBlue bg-transparent block w-full pl-12 p-2.5 outline-none placeholder:text-gray-600"
