...
export const ListAccordion = ({ elements }: Props) => {
  ...
  return (
    <div className="flex flex-col w-full gap-4 px-4 py-2 rounded-md bg-secondaryLight dark:bg-secondaryDark text-black dark:text-white md:rounded-lg">
      <div
      ...
      >
        ...
        <div className="flex flex-row gap-2">
          ...
          >
            <PencilSquareIcon className="w-6 h-6 text-black dark:text-white" />
          </button>
